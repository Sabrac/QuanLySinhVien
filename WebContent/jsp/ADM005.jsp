...
<!-- Begin vung input-->
	...
	<input type="hidden" value="ADM005" name="ref" />
	...
	<table border="0" cellpadding="4" cellspacing="0" width="300px">
		<tr>
			<th width="200px" align="center">&nbsp;</th>
				<td>
					<input class="btn" type="button" onclick="javascript:test('/manage_user_vuhongha/AddUser.do');" value="編集" />
				</td>
				<td>
					<input class="btn" type="button" onclick="" value="削除" />
				</td>
				<td>
					<input class="btn" type="button" onclick="javascript:window.location.href='${back}';" value="戻る" />
				</td>
		</tr>
	</table>
	<!-- End vung button -->
